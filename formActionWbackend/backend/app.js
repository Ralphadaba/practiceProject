...
app.post('/opinions', async (req, res) => {
  ...
  await new Promise((resolve) => setTimeout(resolve, 1000)); //Simulates a slow backend so we can see optimistic updating in action // This will cause the upvote and downvote to display after 1s
